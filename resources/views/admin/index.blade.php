...
@section('title')
Admin Login || Ajayi Polytechnic LMS
@endsection
    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                ...
                <div class="intro-x mt-2 text-gray-500 text-center">Please Login with your Email and password </div>
                <form method="post" action="{{ route('login') }}">
                    <div class="intro-x mt-8">
                        <div class="form-group">
                            <label>Email</label>
                            <input type="text" name="username" class="intro-x login__input input input--lg border border-gray-300 block mt-4" placeholder="Enter Email" />
                        </div><br>
                        <div class="form-group">
